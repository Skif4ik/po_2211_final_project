...
public class DbConstants {
    ...
    public static final String SELECT_ITEMS_FOR_ORDER = "SELECT f.name, f.price, o.quantity, (price*quantity) amount FROM foodItem f INNER JOIN orderItem o ON f.id = o.itemId WHERE 0.orderId = ?";
